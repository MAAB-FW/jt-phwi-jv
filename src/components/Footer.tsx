    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/lessons" className="hover:text-white transition-colors">Vocabulary Lessons</Link></li>
              <li><Link href="/practice" className="hover:text-white transition-colors">Practice Exercises</Link></li>
              <li><Link href="/dictionary" className="hover:text-white transition-colors">Japanese Dictionary</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/forum" className="hover:text-white transition-colors">Discussion Forum</Link></li>
              <li><Link href="/study-groups" className="hover:text-white transition-colors">Study Groups</Link></li>
              <li><Link href="/events" className="hover:text-white transition-colors">Language Events</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Japanese Vocabulary Learning. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
